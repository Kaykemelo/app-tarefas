...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('details-create.css') }}">
</head>
<body>

    <header class="header-tarefa">
        <h2>Criação de Detalhe</h2>
    ...
    <main class="container">
        <div class="formulario">
            <div class="form-tasks"> 
                ...
                <form action="{{ Route('detail-insert') }}" method="post">
                    @csrf
                    <label for="task">Tarefa:</label><br>
                    <input type="text" id="task-input" name="description" value="{{ $task['description'] }}" disabled><br>
